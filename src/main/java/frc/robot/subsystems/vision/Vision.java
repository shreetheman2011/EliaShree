...
public class Vision extends SubsystemBase {
    ...
    public VisionMeasurement getVisionMeasurement() {
        ...
        //if so, avg
        if (limelight1Pose.tagCount >= 2 && limelight2Pose.tagCount >= 2 && limelight1Pose.avgTagDist < 5 && limelight2Pose.avgTagDist < 5 ){
            return new VisionMeasurement(averageOfPoses, ((limelight1Pose.timestampSeconds + limelight2Pose.timestampSeconds) / 2)); 

        } else if (limelight2Pose.tagCount >=2 && limelight2Pose.avgTagDist < 5 ){
        ...
        } else if (limelight1Pose.tagCount >=2 && limelight1Pose.avgTagDist < 5 ) {
